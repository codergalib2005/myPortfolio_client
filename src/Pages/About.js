  ...
  return (
    <div className="pb-20" style={{ minHeight: "90vh" }}>
      <div className="container text-center px-6">
        <h2 className="text-4xl text-gray-100 hover:text-red-300 transform scale-100 hover:scale-105 smooth px-5 font-bold image-border">
          About me
        </h2>
      </div>
      <div className="container grid grid-cols-1 md:grid-cols-2 px-6">
        ...
        <div className="pt-20">
          ...
          <div className="flex items-center flex-wrap py-3">
            <a
              href="https://facebook.com/codergalib20"
              rel="noreferrer"
              target="_blank"
