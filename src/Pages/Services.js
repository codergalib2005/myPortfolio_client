  ...
  return (
    <div className="text-red-50">
      ...
      <div className="container py-10 mx-auto px-6 grid grid-cols-1 sm:grid-cols-2">
        <div
          className=" sm:border-r-2 sm:border-red-500 flex items-center flex-col"
          style={{ minHeight: "500px" }}
        >
          {/* ====//Services Item//===== */}
          <div
            className="flex items-center justify-center p-10 bg-gray-700 m-5 "
            style={{ minHeight: "200px" }}
          >
            <div>
              <h2 className="text-2xl font-bold pb-3 text-gray-100 hover:text-red-400 transform scale-100 hover:scale-105 smooth">
                Mern Stack code Architecture & Design
              </h2>
              <p className="transform scale-100 hover:scale-105 text-gray-100 hover:text-red-400 smooth">
                ...
                methodology, programming practices to improve quality of mern
                stack code.
              </p>
            </div>
          </div>
        ...
        <div className=" flex items-center flex-col">
          ...
          >
            <div>
              ...
              <p className="transform scale-100 hover:scale-105 text-gray-100 hover:text-red-400 smooth">
                I provide end-to-end maintenance and support for the
                uninterrupted performance of your apps round the clock.
              </p>
            </div>
          </div>
        </div>
