    ...
    <div>
      <div class="flex justify-center items-center w-full">
        <label
          ...
          class="flex flex-col justify-center items-center w-full h-64 rounded-lg border-2 border-dashed cursor-pointer hover:bg-bray-800 bg-gray-700 hover:border-gray-500 hover:bg-gray-600"
        >
